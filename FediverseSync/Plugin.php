    ...
    public static function renderFediverseComments($comments)
    {
        ...
        if (!empty($comments)) {
            foreach ($comments as $comment) {
                ...
                // 头像
                $html .= '<img class="author-avatar" src="' . htmlspecialchars($comment['author_avatar']) . '">';
